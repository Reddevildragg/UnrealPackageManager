...
#include "BPable_WorldSubsystem.generated.h"
...
class BLUEPRINTABLESUBSYSTEM_API UBPable_WorldSubsystem : public UWorldSubsystem, public FActivation
{
	GENERATED_BODY()
...
public:
	...
	DECLARE_DYNAMIC_MULTICAST_SPARSE_DELEGATE_TwoParams(FActivatedSignature, UBPable_WorldSubsystem, OnActivated,
	                                                    UObject*, Object, bool, bReset);

	DECLARE_DYNAMIC_MULTICAST_SPARSE_DELEGATE_OneParam(FDeactivateSignature, UBPable_WorldSubsystem,
