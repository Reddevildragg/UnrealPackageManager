...
#include "BPable_TickableWorldSubsystem.generated.h"

UCLASS(Abstract, Blueprintable, BlueprintType)
class BLUEPRINTABLESUBSYSTEM_API UBPable_TickableWorldSubsystem : public UBPable_WorldSubsystem,
                                                                  public FTickableSubsystem
{
	GENERATED_BODY()

public:
	UBPable_TickableWorldSubsystem()
